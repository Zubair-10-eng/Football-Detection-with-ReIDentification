...
class Tracker:
    ...
    def assign_id(self, features, bbox):
        best_id, best_sim = None, 0
        for pid, feats in self.player_features.items():
        ...
        for i, det in enumerate(detections):
            ...
            for t in tracked:
                ...
                if cid == cls_inv['player']:
                    ...
                    tracks["players"][i][pid] = {"bbox": bbox, "features": feats, "track_id": tid}
